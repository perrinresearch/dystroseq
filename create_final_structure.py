"""
Create the final correctly formatted structure files with proper confidence integration.
"""
...
def create_final_pdb_file(atoms: List[Dict], confidence_scores: List[float], output_file: str):
    """Create the final correctly formatted PDB file."""
    print(f"Creating final PDB file: {output_file}")
    ...
    with open(output_file, 'w') as f:
        ...
        f.write("REMARK   3 FINAL CORRECTLY FORMATTED FOR VMD COMPATIBILITY\n\n")
    ...
    print(f"Final PDB file created: {output_file}")


def create_final_cif_file(atoms: List[Dict], confidence_scores: List[float], output_file: str):
    """Create the final correctly formatted CIF file."""
    print(f"Creating final CIF file: {output_file}")
    ...
    with open(output_file, 'w') as f:
        ...
        f.write("# Final correctly formatted for VMD compatibility\n\n")
    ...
    print(f"Final CIF file created: {output_file}")


def main():
    """Main function to create the final correctly formatted structure files."""
    base_dir = "../../../Data/dystrophin/folds_2025_10_22_19_55"
    
    print("=" * 60)
    print("CREATING FINAL CORRECTLY FORMATTED STRUCTURE FILES")
    print("=" * 60)
    ...
    for i, struct in enumerate(sorted_structures):
        ...
        print(f"  Confidence data length: {len(confidence)}")
    ...
    print(f"Combined confidence data has {len(combined_confidence)} scores")
    
    # Create final files
    print("\nCreating final structure files...")
    create_final_pdb_file(combined_atoms, combined_confidence, "dystrophin_final.pdb")
    create_final_cif_file(combined_atoms, combined_confidence, "dystrophin_final.cif")
    
    print(f"\nFinal structure files created:")
    print(f"  - dystrophin_final.pdb (VMD-compatible PDB format)")
    print(f"  - dystrophin_final.cif (Proper CIF format)")
